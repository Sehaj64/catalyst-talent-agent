...
2. Click `Run Agent`.
3. Walk through parsed role signals: skills, seniority, location, domain.
4. Show the discovery strategy and audit trace.
5. Review the top candidate's match score, interest score, transcript, evidence, and next steps.
6. Export JSON and explain how it can be handed to a recruiter or ATS.
