...
def build_learning_plan_prompt(
    ...
    payload = assessment_payload(scored, learning_style, weekly_hours)
    return (
        "TASK: Architect elite 'Zero-to-Expert' Roadmap. \n"
        "IDENTITY: Technical Mentor. \n"
        "RULES:\n"
        "1. NO GENERIC ADVICE: Say 'Master implementation of X using Y to solve Z'.\n"
        "2. PROOF: Every skill MUST have a complex mini-project.\n"
        "3. DEEP RESOURCES: Documentation sections or whitepapers.\n\n"
        ...
        "      \"target_level\": \"What they need\",\n"
        "      \"why_now\": \"Business risk\",\n"
        "      \"adjacent_bridge\": \"How existing skills help\",\n"
        "      \"estimated_hours\": \"Time\",\n"
        "      \"course_path\": [\"Link 1\", \"Link 2\"],\n"
        "      \"weekly_schedule\": [\"Day 1\", \"Day 2\"],\n"
        "      \"practice_drill\": \"Coding drill\",\n"
        "      \"proof_artifact\": \"Project description\",\n"
        "      \"retest_prompt\": \"Tough interview question\"\n"
        "    }\n"
        "  ]\n"
        "}\n\n"
        + json.dumps(payload, indent=2)
